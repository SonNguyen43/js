...
letDeclaration();
/**
 * Hoistring xảy ra với var nhưng không xảy ra với let & const
...
demo();
/**
 * Similarly, the compiler will give an error if we declare a variable that was already passed(đã được thông qua) in as an argument(đối số) to the function
 */
